...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/assets/vendor/nucleo/css/nucleo.css"/>"
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/assets/vendor/fortawesome/fontawesome-free/css/all.min.css"/>"
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/assets/css/argon.css?v=1.0.0"/>"
	media="screen" />


<link href="<c:url value="/resources/imagens/sbc_logo.ico"/>" rel="icon"
	type="image/x-icon" />
<link href="<c:url value="/resources/imagens/sbc_logo.ico"/>"
...
<c:forEach items="${cssFiles}" var="file">
	<c:url var="url" value="/resources/assets/${file}" />
...
<body>
	...
	<script
		src="<c:url value="/resources/assets/vendor/jquery/dist/jquery.min.js"/>"></script>
	<script
		src="<c:url value="/resources/js/bootstrap/bootstrap.bundle.min.js"/>"></script>
	<script
		src="<c:url value="/resources/js/jquery/jquery.datetimepicker.full.min.js"/>"></script>
	<script
		src="<c:url value="/resources/js/msbc-validator-1.8.0.min.js"/>"></script>
	<script src="<c:url value="/resources/js/funcoes.js"/>"></script>
	<script src="<c:url value="/resources/js/ObjetoIdValor.js"/>"></script>


	<!-- Argon Scripts-->
	<script
		src="<c:url value="/resources/assets/vendor/chart.js/dist/Chart.min.js"/>"></script>
	<script
		src="<c:url value="/resources/assets/vendor/chart.js/dist/Chart.extension.js"/>"></script>
	<script src="<c:url value="/resources/assets/js/argon.js?v=1.0.0"/>"></script>


	<c:forEach items="${jsFiles}" var="file">
		<c:url var="url" value="/resources/${file}" />
