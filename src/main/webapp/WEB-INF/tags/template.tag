...
<link rel="stylesheet" type="text/css"
	href="<c:url value="${urlRecursos}resources-admin/assets/vendor/nucleo/css/nucleo.css"/>"
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="${urlRecursos}resources-admin/assets/vendor/fortawesome/fontawesome-free/css/all.min.css"/>"
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="${urlRecursos}resources-admin/assets/css/argon.css?v=1.0.0"/>"
	media="screen" />
...
<c:forEach items="${cssFiles}" var="file">
	<c:url var="url" value="${urlRecursos}resources-admin/assets/${file}" />
...
<body>
	...
	<script
		src="<c:url value="${urlRecursos}resources-admin/assets/vendor/jquery/dist/jquery.min.js"/>"></script>
	<script
		src="<c:url value="${urlRecursos}resources-admin/js/bootstrap/bootstrap.bundle.min.js"/>"></script>
	<script
		src="<c:url value="${urlRecursos}resources-admin/js/jquery/jquery.datetimepicker.full.min.js"/>"></script>
	<script
		src="<c:url value="${urlRecursos}resources-admin/js/msbc-validator-1.8.0.min.js"/>"></script>
	<script src="<c:url value="${urlRecursos}resources-admin/js/funcoes.js"/>"></script>
	<script src="<c:url value="${urlRecursos}resources-admin/js/ObjetoIdValor.js"/>"></script>


	<!-- Argon Scripts-->
	<script
		src="<c:url value="${urlRecursos}resources-admin/assets/vendor/chart.js/dist/Chart.min.js"/>"></script>
	<script
		src="<c:url value="${urlRecursos}resources-admin/assets/vendor/chart.js/dist/Chart.extension.js"/>"></script>
	<script src="<c:url value="${urlRecursos}resources-admin/assets/js/argon.js?v=1.0.0"/>"></script>


	<c:forEach items="${jsFiles}" var="file">
		<c:url var="url" value="${urlRecursos}resources-admin/${file}" />
